...
class faunahelper():
    ...
    def update_days_by_telegram_id(self, id, new_number_days):
        self.clientf.query(query.update(query.select('ref', query.get(query.match(query.index('students_by_telegram_id'), id))), {'data': {'days': new_number_days}}))
